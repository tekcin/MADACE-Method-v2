...
interface Props {
  ...
  onChange: (field: keyof ProjectInput, value: number) => void;
}

export function AssessmentForm({ input, onChange }: Props) {
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
          Answer these 8 questions to determine the recommended planning level for your project
        </p>
      </div>
