...
**Assessment Date:** {{formatDate date}}
**Recommended Level:** Level {{level}} ({{levelName level}})
**Total Score:** {{score}}/40 points
  ...
  steps:
    ...
    - name: "Route to Appropriate Workflow"
      ...
      routing:
        ...
        level_3: ["plan-project", "create-tech-specs", "create-architecture", "create-epics", "create-stories"]
        level_4: ["plan-project", "create-tech-specs", "create-architecture", "create-security-spec", "create-devops-spec", "create-epics", "create-stories"]
```
        ...
        <div className="mt-6 p-4 border rounded-lg bg-blue-50 dark:bg-blue-900">
          ...
          <div className="flex items-center gap-4">
            ...
            <span className="text-sm text-gray-600">
              Score: {assessment.score}/40 points
            </span>
          </div>
